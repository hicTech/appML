...
/* jsOn function constructor and prototype... */
	...
	jsOnFn.prototype = {
		...
		labelHtml: function(label, end){
			return end ? "" : "<div onclick=\"jsOn.toggle(this,'."+this.css("container_marker")+"','."+this.css("content_marker")+"',true)\" class='"+this.css("label")+"'> " + label + ": </div>";
		...
		buttonHtml: function(label, click_fn){
			return "<div class='"+this.css("button")+"' onclick=\""+click_fn+"\"> { "+label+" } </div>";
		},
